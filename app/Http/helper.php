        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-2">
                <a class="text-decoration-none text-dark cursor-pointer" href="/financial-details/'.$date->toDateString().'/'.$id.'">
                    ...
                    <div class="card-text d-flex text-dark m-0 text-center border-bottom-1">
                        <div class="w-100 fs-3">
                            '.format_amount($gap).'
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-6 d-flex flex-column justify-content-center">
                <a class="text-decoration-none text-dark cursor-pointer" href="/financial-details/'.$date->toDateString().'/'.$id.'">
                    <p class="text-center m-0">Deposit</p>
                    <div class="card-text d-flex text-dark">
                        ...
                        <div class="w-25 d-flex align-items-center">
                            '.(($deposit>=$lastdeposit)?'<i class="fa fa-angle-double-up text-success  me-4px fs-7 me-0" aria-hidden="true"></i>':'<i class="fa fa-angle-double-down text-danger  me-4px fs-7 me-0" aria-hidden="true"></i>').'
