                ...
                @if(array_intersect($bankAccountCodes, permissions()))
                    ...
                    <div class="row mt-2">
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title bg-success p-2 rounded text-light w-100 d-flex"><span class="text-start w-75">{{date('d/m/Y',strtotime($startDate))}} Financials</span><span class="text-end">{{$brand->name}}</span></h5>
                                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title bg-success p-2 rounded text-light w-100 d-flex"><span class="text-start w-75">{{date('d/m/Y',strtotime($endDate))}} Financials</span><span class="text-end">{{$brand->name}}</span></h5>
                                    <?php
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title bg-success p-2 rounded text-light w-100 d-flex"><span class="text-start w-75">Monthly Financials</span><span class="text-end">{{$brand->name}}</span></h5>
                                    <?php
